...
import Load from '../Load/Load';
 ...
 const Sports = () => {
    ...
    const urls = `https://newsapi.org/v2/top-headlines?country=in&category=sports&apiKey=fca1f4a6a36e489dba3a5e0e1f6df865`
...
useEffect(() => {
  ...
  return (
    <>
      ...
      <div className="row">
        {data.map((currelm) => (
          <div className="col-md-3 mb-3" key={currelm.id}>
